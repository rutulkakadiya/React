...
export default function CondensendMilk() {
    ...
    const displayProducts = sortProducts?.filter((item)=> item.category == "condensed") || [];
                ...
                <div className="mainDiv w-[100%] lg:w-[80%] border flex">
                    ...
                    <div className="div2 w-[80%] h-[81vh] overflow-scroll">
                        <div className="sort flex justify-between mt-3">
                            <p className='ps-3 font-semibold'>Buy Condensed Milk Online</p>
