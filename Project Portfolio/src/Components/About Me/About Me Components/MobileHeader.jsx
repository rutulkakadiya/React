        ...
        <div className='block xl:hidden'>
            <div className="dynamicDiv bg-[var(--bg-color)] z-50 h-[60px] w-[100%] xl:w-[80%] flex justify-between items-center border border-[#4f4f4f] fixed top-0">
                ...
                <div className="colorThemeChange flex items-center relative">
                    ...
                    <div
                        className={`colorDiv absolute top-[50px] flex justify-around flex-wrap items-center h-[80px] w-[130px] right-[15px] bg-[var(--header-color)] border border-white rounded-[10px] transition-all duration-500 ${showSlideDiv ? 'top-0' : 'top-[-90px]'
                            }`}
                    >
