...
export default function JewelleryCategory() {
    ...
    const jeweleryCategory = displayProducts?.filter((product) => product.category === "jewelery")
    const searchProducts = jeweleryCategory.filter((item) => item.title.toLowerCase().includes(search.toLocaleLowerCase()));
