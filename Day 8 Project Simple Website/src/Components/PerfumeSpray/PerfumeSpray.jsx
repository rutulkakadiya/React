...
import { PerfumeSpray_DataArr } from './PerfumeSprayAPI'
...
export default function PerfumeSpray() {
  ...
  const handleSorting = (e) => {
    ...
    dispatch(sortProducts({ option, dataArray: PerfumeSpray_DataArr }));
  };
  ...
  const displayProducts = sortOption != 'featured' && sortedProducts ? sortedProducts : PerfumeSpray_DataArr;

  return (
    <div>
      <Nav />
      <p className='text-center text-3xl mt-5' data-aos="fade-up" data-aos-duration="2000">ADILQADRI PREMIUM PERFUME SPRAY (EDP)</p>
