...
import { BodySpray_DataArr } from './BodySprayAPI'
...
export default function BodySpray() {
  ...
  const handleSorting = (e) => {
    ...
    dispatch(sortProducts({ option, dataArray: BodySpray_DataArr }));
  };
  ...
  const displayProducts = sortOption != 'featured' && sortedProducts ? sortedProducts : BodySpray_DataArr;

  return (
    <div>
      <Nav />
      <p className='text-center text-3xl mt-5' data-aos="fade-up" data-aos-duration="2000">ADILQADRI PREMIUM DEODRANT BODYSPRAY</p>
