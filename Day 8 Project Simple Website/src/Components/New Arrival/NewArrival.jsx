...
import { NewArrival_DataArr } from './NewArrivalAPI'
...
export default function NewArrival() {
  ...
  const handleSorting = (e) => {
    ...
    dispatch(sortProducts({ option, dataArray: NewArrival_DataArr }));
  };
  ...
  const displayProducts = sortOption != 'featured' && sortedProducts ? sortedProducts : NewArrival_DataArr;
